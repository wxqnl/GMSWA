...
from fla.models.gated_mem_swa import GatedMemSWAConfig, GatedMemSWAForCausalLM, GatedMemSWAModel
...
try:
    from fla.models.qwen2_semarope import (
        Qwen2SemaRoPEConfig,
    ...
    Qwen2SemaRoPEConfig = None
    Qwen2SemaRoPEForCausalLM = None
    Qwen2SemaRoPEForQuestionAnswering = None
    Qwen2SemaRoPEForSequenceClassification = None
    Qwen2SemaRoPEForTokenClassification = None
    Qwen2SemaRoPEModel = None
...
if Qwen2SemaRoPEConfig is not None:
    __all__.extend([
        'Qwen2SemaRoPEConfig',
        'Qwen2SemaRoPEForCausalLM',
        'Qwen2SemaRoPEForQuestionAnswering',
