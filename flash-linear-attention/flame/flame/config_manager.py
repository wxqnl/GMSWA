...
class JobConfig:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            default=True,
            help="Whether to pin host memory in the dataloader for faster host-to-device copies.",
        )
        self.parser.add_argument(
            "--training.persistent_workers",
            action=argparse.BooleanOptionalAction,
            default=False,
            help="Whether to keep dataloader worker processes alive across epochs/iterator recreations.",
        )
        self.parser.add_argument(
