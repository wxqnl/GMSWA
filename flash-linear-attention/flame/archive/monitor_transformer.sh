...
CON=$FLAME/saves/Transformer-340M-10k.train.console.log
STATUS=$FLAME/saves/Transformer-340M-10k.STATUS.txt
HIST=$FLAME/saves/Transformer-340M-10k.history.tsv
...
while true; do
  ...
  ck=$(ls $FLAME/saves/Transformer-340M-10k/checkpoint/ 2>/dev/null | tr '\n' ' ')
